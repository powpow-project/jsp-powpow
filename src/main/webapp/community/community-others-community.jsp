...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/community/community-others-community.css">
...
<body>
    ...
    <div class="myCommunity-wrapper">
      ...
      <div class="myCommunity">
          ...
          <div class="myProfile-card">
            <div class="myProfile-card-image-wrapper">
              <div class="myProfile-card-image">
                <img src="../assets/images/community/profilebiggerimage2.png" alt="마이 프로필이미지">
                <p class="h4">바나바나</p>
              </div>
            </div>
            <div class="myProfile-line"></div>
            <div class="myProfile-button">
              <button><a href="#">팔로우</button>
            </div>
        ...
        <div class="my-post">
          <div class="title">
            <p class="h5">바나바나</p><p class="h5">님의 게시물</p>
          </div>
...
<script>
      ...
      const followButton = document.querySelector(".myProfile-button");

      followButton.addEventListener("click", (e) => {
        if(e.target.className === "myProfile-button") {
          e.target.setAttribute("class", "following")
          e.target.innerText = "팔로잉";
          e.target.style.backgroundColor = "#113F8A";
          e.target.style.color = "#FFFFFF";
        }else{
          e.target.setAttribute("class", "myProfile-button")
          e.target.innerText = "팔로우";
          e.target.style.backgroundColor = "#FFFFFF";
          e.target.style.color = "#131313";
        }      
      })
