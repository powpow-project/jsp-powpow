...
<link rel="stylesheet" href="../assets/css/login/seller-join-complete.css"/>
...
<div class="completion-main">
    ...
    <div class="box">
      <img  id="check" src="../assets/images/login/complete-check.svg" alt="체크">
    
      <p class="text">POWPOW 판매자 회원가입이 완료되었습니다.</p>
