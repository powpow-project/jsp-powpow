...
<body>
	<form action="seller-update-ok.seller" method="post" id="frame"
		...
		<div id="product-insert">
			...
			<div class="info-wrap">
				<input type="hidden" name="id" value="${product.id}" /> <input
					type="hidden" name="productCode" value="${product.productCode}" />
				<div class="list-wrap">
					<p class="h6">상품명</p>
				...
				<div class="list-wrap">
					<p class="h6">분류</p>
					<select name="productCategoryAge">
				...
				<div class="list-wrap">
					<p class="h6">상품간략설명</p>
					<textarea id="productDetailTextarea" name="productDetail"
						class="description" placeholder="내용을 설명해주세요."><c:out
							value="${product.productDetail}"></c:out></textarea>
				</div>
			</div>
			<div class="line">
				<hr />
					...
					<div class="main">
						...
						<label for="main">
							<div class="main-image">
								<img id="main-preview"
									src="../assets/images/product/${product.productImage}" alt="#" />
							</div>
					...
					<div class="sub-wrap">
						<div class="sub">
							...
							<label for="sub1">
								<div class="sub-image">
									<img id="sub1-preview"
										src="../assets/images/product/${product.productSubImage1}"
										alt="#" />
								</div>
						...
						<div class="sub">
							...
							<label for="sub2">
								<div class="sub-image">
									<img id="sub2-preview"
										src="../assets/images/product/${product.productSubImage2}"
										alt="#" />
								</div>
						...
						<div class="sub">
							...
							<label for="sub3">
								<div class="sub-image">
									<img id="sub3-preview"
										src="../assets/images/product/${product.productSubImage3}"
										alt="#" />
								</div>
