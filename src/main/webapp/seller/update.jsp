            ...
            <div class="shipping-wrap">
              ...
              <div class="list-wrap">
                ...
                <div class="radio-wrap">
                  <div class="radio">
                    <input type="radio" name="shipping-pay" value="무료" /><span class="h6"
                      >무료</span
                    >
                  </div>
                  <div class="radio">
                    <input type="radio" name="shipping-pay" value="유료" /><span class="h6"
                      >유료</span
                    >
                  </div>
                  <div class="radio">
              ...
              <div class="list-wrap">
                ...
                <div class="radio-wrap">
                  <div class="radio">
                    <input type="radio" name="shipping-company" checked /><span class="h6"
                      >일반택배배송</span
                    >
                  </div>
                  <div class="radio">
                    <input type="radio" name="shipping-company" /><span class="h6"
                      >자체배송</span
                    >
                  </div>
                </div>
              ...
              <div class="list-wrap">
                ...
                <div class="radio-wrap">
                  <div class="radio">
                    <input type="radio" name="shipping-paylater" checked /><span class="h6"
                      >선결제</span
                    >
                  </div>
                  <div class="radio">
