	...
	<div id="frame">
		...
		<section class="notice-search">
			...
			<div class="buttons">
				...
				<button class="new-add-btn"
					onclick="location.href='seller-write.seller'">상품등록</button>
			</div>
		</section>
							...
							<td>
								<div class="change-buttons">
									<button type="button" class="edit-btn"
										onclick="location.href='seller-update.seller?id=${product.id}'">수정</button>
									<button type="button" class="delete-btn"
										data-productid="${product.id}">삭제</button>
								</div>
							</td>
						</tr>
					</c:forEach>
