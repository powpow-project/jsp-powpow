...
<link rel="stylesheet" href="../assets/css/member/member-seller-password-change.css"/>
...
<div class="change-passwrod-main">
        ...
        <a href="http://localhost:9000/powpow/member/password-change-complete.jsp">
          <button class="login-button">확인</button>
        </a>
      </div>
  <script src="../assets/js/jQuery.js"></script>
  <script src="../assets/js/member/member-seller-password-change.js"></script>
</body>
</html>
