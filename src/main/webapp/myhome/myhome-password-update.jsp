...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/myhome/myhome-password-update.css">
...
<body>
  ...
  <div id="sub">
    ...
    <span class="sub-sub">
      <a href="./list.myhome" class="h4">프로필</a>
      <p>|</p>
      <a href="./likes-list.myhome" class="h4">좋아요</a>
      <p>|</p>
      <a href="./notification.myhome" class="h4">알림설정</a>
      <p>|</p>
      <a href="./password-update.myhome" class="current-category h4">비밀번호 변경</a>
    </span>
  </div>
