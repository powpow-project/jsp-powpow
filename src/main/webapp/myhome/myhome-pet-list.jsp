    ...
    <div class="header-container">
        <div id="header-wrap">
            <div id="border">
                <div id="nav">
                    <div class="left">
                        <a href="../index.jsp"><img src="../assets/images/myhome/logo.png" alt="로고"></a>
                    </div>
                    <div class="right">
                        <div class="icons">
                            ...
                            <a href="../product/cartlist.product"><img src="../assets/images/myhome/shopping_cart_icon2.jpg" alt="카트"></a>
                        </div>
                        <div class="bar"></div>
