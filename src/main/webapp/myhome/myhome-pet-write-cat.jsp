...
<link rel="stylesheet"
	href="../assets/css/myhome/myhome-pet-write-cat.css">
...
<body>
	...
	<form action="pet-write-ok.myhome?petKind=cat" method="post" id="frame"
		...
		<div id="mydog">
			...
			<div class="input-wrap">
				<input class="input" id="petName" type="text" name="petName"
					placeholder="미미"> <label class="option"> <input
