...
<title>마이홈 반려묘추가</title>
<link rel="stylesheet" href="../assets/css/myhome/myhome-pet-write-cat.css">
				...
				<div class="menu-container">
					...
					<div class="sub-menu-wrap">
						...
						<ul>
							...
							<li class="sub-menu"><a href="./myhome-pet-list.jsp">반려동물
									정보</a></li>
							<li class="sub-menu"><a href="./myhome-shipping-list.jsp">나의
									쇼핑</a></li>
	...
	<form action="pet-write-ok.myhome?petKind=bird" method="post" id="frame" enctype="multipart/form-data">
		...
		<div id="mydog">
			...
			<div class="input-wrap">
				<input class="input" id="petName" type="text" name="petName" placeholder="미미"> 
				<label class="option"> 
				...
				<label class="option">
					<input name="petNeuter" type="radio" value="yes">
						<p>했어요</p> 
...
<script src="../assets/js/myhome/myhome-pet-write-cat.js">
