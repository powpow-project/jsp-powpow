        ...
        <div class="menu-wrap">
            ...
            <div id="menu-frame">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <a href="../admin/admin-banner-list.admin" style="color: white;">배너 관리</a>
                        </p>
                        <div>
                            <p>
            ...
            <div class="notice-search">
                <div class="search-row">
                    <div class="search-bar">
                        ...
                        <input type="text" class="search" placeholder="검색어를 입력해주세요" id="search-input" />
                    </div>
                ...
                <div class="search-row">
                    ...
                    <div class="email-receive">
                        <label>메일 수신여부</label>
                        <input type="radio" id="email-yes" name="email" value="yes" /> 수신
