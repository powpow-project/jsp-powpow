...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../assets/css/admin/announcementPost.css">
    <link rel="stylesheet" href="../assets/css/index.css">
    <link rel="icon" href="../assets/images/favicon.ico">
    <title>공지사항 신규등록</title>
</head>
<body>
    <form action="post-ok.admin" method="post" id="frame">
        <div class="menu-wrap">
    ...
    <script src="../assets/js/admin/announcementPost.js"></script>
</body>
</html>