 ...
 <div id="frame">
  ...
  <section class="notice-search">
    ...
    <div class="buttons">
      ...
      <button class="new-add-btn" onclick="location.href='product-write.product'">상품등록</button>
    </div>
  </section>
  ...
  <section class="notice-list">
    ...
    <div class="pop-up">
      ...
      <div class="check-buttons">
        <button class="delete-btn" onclick="location.href='delete-ok.product?id=${product.id}'">확인</button>
