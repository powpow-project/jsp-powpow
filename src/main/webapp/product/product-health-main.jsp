...
<body>
	...
	<div id="content-frame">
						...
						<c:if test="${product.productCategoryName == '강아지' && (product.productAge == '퍼피' || product.productAge == '어덜트' || product.productAge == '시니어')}">
							<div class="product swiper-slide dog-items" data-category="강아지 ${product.productAge}">
								<div class="product-image-wrap">
									<img class="main-image" src="../assets/images/product/${product.productImage}"alt="${product.productName}">
									<img class="sub-image" src="../assets/images/product/${product.productSubImage1}"alt="${product.productName}">
									<div class="hover-box">
		...
		<div class="recommendation-section-brid">
			<div class="all-and-header">
				<div class="section-header-container">
					<div class="section-header">
					...
					<div class="category-buttons brid-category-buttons">
						<button data-category="새 퍼피" class="category-button">퍼피</button>
			...
			<div class="slider-container-brid swiper-container brid-swiper">
			    <div class="swiper-button-next"></div>
      			<div class="swiper-button-prev"></div>
				<div class="slider swiper-wrapper brids-swiper-warpper">
	
				<c:forEach var="product" items="${products}">
						<c:if test="${product.productCategoryName == '새' && (product.productAge == '퍼피' || product.productAge == '어덜트' || product.productAge == '시니어')}">
							<div class="product swiper-slide brid-items" data-category="새 ${product.productAge}">
								<div class="product-image-wrap">
		...
		<div class="recommendation-section-fish">
			<div class="all-and-header">
				<div class="section-header-container">
					...
					<div class="category-buttons fish-category-buttons">
						<button data-category="물고기 퍼피" class="category-button">퍼피</button>
			...
			<div class="slider-container-fish swiper-container fish-swiper">
			    <div class="swiper-button-next"></div>
      			<div class="swiper-button-prev"></div>
				<div class="slider swiper-wrapper fishs-swiper-warpper">
	
				<c:forEach var="product" items="${products}">
						<c:if test="${product.productCategoryName == '물고기' && (product.productAge == '퍼피' || product.productAge == '어덜트' || product.productAge == '시니어')}">
							<div class="product swiper-slide fish-items" data-category="물고기 ${product.productAge}">
								<div class="product-image-wrap">
									<img src="../assets/images/product/${product.productImage}"alt="${product.productName}">
									<div class="hover-box">
										<div class="hover-box-new">
